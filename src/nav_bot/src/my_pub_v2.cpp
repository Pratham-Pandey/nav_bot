...
namespace nav_bot{
  class NavigateTo : public rclcpp::Node{
    public:
      ...
      NavigateTo(const rclcpp::NodeOptions & options) : Node("navigate_to", options){
...
//RCLCPP_COMPONENTS_REGISTER_NODE(nav_bot::NavigateTo)
RCLCPP_COMPONENTS_REGISTER_NODE(nav_bot::NavigateTo)
...
//   auto naode = std::make_shared<action_tutorials_cpp::NavigateTo>(rclcpp::NodeOptions());
//   rclcpp::spin(node);
//   rclcpp::shutdown();
//   return 0;
// }